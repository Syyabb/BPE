...
def main():
    ...
    # netC.load_state_dict(torch.load('/data1/bingxu/pycharm_ssh/backdoor_sota/warp_and_blend_uap/patch_no_norm3.pt'))
    netC.load_state_dict(torch.load('/data1/bingxu/pycharm_ssh/backdoor_sota/warp_and_blend_uap/all2all_patch.pt'))
    # netC.load_state_dict(torch.load('/data1/bingxu/pycharm_ssh/backdoor_sota/gtsrb_warp/patch_iter.pt'))
    netC.to(opt.device)
    netC.eval()
