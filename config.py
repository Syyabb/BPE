...
def get_arguments():
    ...
    parser.add_argument("--trigger_type", type=str, default="sig")
    parser.add_argument("--adversarial_maxiter", type=int, default=7)
    parser.add_argument("--model_path", type=str, default="./pt/all2all_patch.pt")
